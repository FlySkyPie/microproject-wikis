...
IDE's in the past always implemented every programming language they supported on their own, it was baked in. Because of this everyone supported different features. With language servers this all changes. A single language server can be created with a community which can be shared across any number of IDE's which support the protocol. To learn more about language servers and IDE's that support them see [langserver.org](https://langserver.org/)
...
![VSCode Lua addon](Static/vscode_lua_addon.png)
...
![VSCode Lua settings](Static/vscode_lua_settings.png)
