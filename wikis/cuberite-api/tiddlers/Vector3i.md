...
Returns a new Vector3i that is a {{https://en.wikipedia.org/wiki/Cross_product|cross product}} of this vector and the specified vector.
...
### Overload 3: constructor(Vector3d)
...
### Overload 1: operator_div(Divisor)
...
### Overload 2: operator_div(PerCoordDivisors)

| Name | Type | Notes |
| --- | --- | --- |
| PerCoordDivisors | Vector3i |  |
...
### Overload 1: operator_mul(Multiplier)
...
### Overload 2: operator_mul(PerCoordMultipliers)

| Name | Type | Notes |
| --- | --- | --- |
| PerCoordMultipliers | Vector3i |  |
